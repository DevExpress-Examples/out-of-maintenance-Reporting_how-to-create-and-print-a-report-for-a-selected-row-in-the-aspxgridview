...
Namespace GridReportPrint
	...
	End Class
End Namespace
Namespace GridReportPrint.NwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, Un" & "itPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued, EAN13" & Constants.vbCrLf & "FROM    " & "        Products WHERE CategoryID = @CatID"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
			Me._commandCollection(0).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("CatID", Global.System.Data.OleDb.OleDbType.Integer, 0, Global.System.Data.ParameterDirection.Input, (CByte(0)), (CByte(0)), Nothing, Global.System.Data.DataRowVersion.Current, False, Nothing))
		End Sub
		...
		Public Overridable Function Fill(ByVal dataTable As NwindDataSet.ProductsDataTable, ByVal CatID As Integer) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(CatID)))
		...
		Public Overridable Function GetData(ByVal CatID As Integer) As NwindDataSet.ProductsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Me.Adapter.SelectCommand.Parameters(0).Value = (CInt(Fix(CatID)))
